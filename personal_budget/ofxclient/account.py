...
class Account(object):
    ...
    """
    def __init__(self, number, institution, description=None, use_in_memory_str_buffer=True):
        self.institution = institution
        self.number = number
        self.description = description or self._default_description()
        self.use_in_memory_str_buffer = use_in_memory_str_buffer
    ...
    def download(self, days=60):
        ...
        ofx_file = open('/tmp/ofxclient.ofx', 'w+')
        ofx_file.write(response)
        return ofx_file
    ...
    def deserialize(raw):
        ...
        """
        from personal_budget.ofxclient.institution import Institution
